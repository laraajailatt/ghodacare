...
class _AddSymptomScreenState extends State<AddSymptomScreen> {
  ...
  final List<String> _timeOfDayOptions = ['Morning', 'Afternoon', 'Evening', 'Night', 'All day'];
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Feature list
              _buildFeatureItem('assets/images/bandageicon.png', 'Track your symptoms to identify patterns and triggers'),
              const SizedBox(height: 16),
              _buildFeatureItem('assets/images/aiicon.png', 'Get AI-powered insights based on your symptom history'),
              const SizedBox(height: 16),
              _buildFeatureItem('assets/images/reporticon.png', 'Share symptom reports with your healthcare providers'),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: _commonSymptoms.keys.toList().sublist(
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          focusedBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(12),
                            borderSide: const BorderSide(color: Color(0xFF814CEB)),
                          ),
                        ...
                        children: _severityOptions.map((severity) {
                          return ChoiceChip(
                            ...
                            labelStyle: TextStyle(
                              color: _selectedSeverity == severity ? Colors.white : Colors.black87,
                              fontWeight: FontWeight.w500,
                            ),
                            onSelected: (selected) {
                              if (selected) {
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: DropdownButtonFormField<String>(
                          ...
                          isExpanded: true,
                          icon: const Icon(Icons.keyboard_arrow_down, color: Color(0xFF814CEB)),
                      ...
                      Wrap(
                        ...
                        children: _triggerOptions.keys.map((trigger) {
                          return FilterChip(
                            ...
                            labelStyle: TextStyle(
                              color: _triggerOptions[trigger] ?? false ? Colors.white : Colors.black87,
                              fontWeight: FontWeight.w500,
                            ),
                            onSelected: (selected) {
                              setState(() {
                      ...
                      Wrap(
                        ...
                        children: _timeOfDayOptions.map((timeOfDay) {
                          return ChoiceChip(
                            ...
                            labelStyle: TextStyle(
                              color: _selectedTimeOfDay == timeOfDay ? Colors.white : Colors.black87,
                              fontWeight: FontWeight.w500,
                            ),
                            onSelected: (selected) {
                              if (selected) {
  ...
  Future<void> _submitSymptom() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (_selectedInfermedicaSymptom != null && _selectedInfermedicaSymptom!.id.isNotEmpty) {
          symptomData['infermedica_id'] = _selectedInfermedicaSymptom!.id;
          symptomData['infermedica_name'] = _selectedInfermedicaSymptom!.name;
          symptomData['infermedica_common_name'] = _selectedInfermedicaSymptom!.commonName;
        }
        ...
        setState(() {
          ...
          if (response['success'] == true) {
            ...
            _commonSymptoms.forEach((key, value) => _commonSymptoms[key] = false);
            _triggerOptions.forEach((key, value) => _triggerOptions[key] = false);
            _showOtherTriggerField = false;
            _selectedInfermedicaSymptom = null;
          } else {
            _errorMessage = response['message'] ?? 'Failed to add symptom. Please try again.';
          }
        });
      } catch (e) {
        setState(() {
