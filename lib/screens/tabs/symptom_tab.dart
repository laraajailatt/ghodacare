...
import 'package:app_ghoda/screens/symptom/symptom_list_screen.dart';
...
class _SymptomTabState extends State<SymptomTab> {
  ...
  Future<void> _loadSymptomData() async {
    ...
    try {
      ...
      _commonTriggers = sortedTriggers
          .take(5)
          .map((e) => e.key)
          .toList();
  ...
  Widget _buildSummaryCards() {
    ...
    final totalSymptoms = _symptomSeverityCounts.values.fold(0, (sum, count) => sum + count);
