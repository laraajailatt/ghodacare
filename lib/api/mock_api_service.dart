...
class MockApiService {
  ...
  static Future<Map<String, dynamic>> addSymptom(Map<String, dynamic> symptomData) async {
    await Future.delayed(_simulatedDelay);
  ...
  static Future<Map<String, dynamic>> addBloodwork(Map<String, dynamic> bloodworkData) async {
    await Future.delayed(_simulatedDelay);
  ...
  static Future<Map<String, dynamic>> deleteBloodwork(String bloodworkId) async {
    await Future.delayed(_simulatedDelay);
  ...
  static Future<Map<String, dynamic>> addHealthMetric(Map<String, dynamic> metricData) async {
    await Future.delayed(_simulatedDelay);
  ...
  static Future<List<InfermedicaSymptom>> getInfermedicaSymptoms() async {
    ...
    return [
      ...
      InfermedicaSymptom(id: 's_4', name: 'Shortness of breath', commonName: 'Shortness of breath'),
      InfermedicaSymptom(id: 's_5', name: 'Fatigue', commonName: 'Fatigue'),
      InfermedicaSymptom(id: 's_6', name: 'Abdominal pain', commonName: 'Abdominal pain'),
    ];
  }
} 