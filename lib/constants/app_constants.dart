...
class AppConstants {
  ...
  // API Configuration
  static const String baseUrl = "http://10.0.2.2:8000/api";  // Local development server URL for Android emulator
  static const String infermedicaApiUrl = "https://api.infermedica.com/v3"; // Infermedica API URL
